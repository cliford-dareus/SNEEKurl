            ...
            <div className="max-w-4xl mx-auto space-y-6">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <div
                                    className={`px-3 py-1 rounded-full text-white text-sm font-medium ${getPlanBadgeColor(plan)}`}>
                ...
                <div className="bg-base-100 rounded-xl border border-error/20 overflow-hidden">
                    <div className="p-6 bg-error/5">
                        ...
                        <div
                            className="flex items-center justify-between p-4 bg-base-100 rounded-lg border border-error/20">
                            <div>
