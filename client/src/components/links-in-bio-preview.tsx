...
import {PageProps} from "./modals/customize-links-in-bio-modal";
...
const linksInBioPreview = ({data, isLoading, classnames, container}: Props ) => {
    ...
    return(
        <main
            className={classNames("bg-black", classnames)}
            style={{...getBackgroundColor(), color: data?.textColor}}
        >
            <div className={classNames("w-full flex flex-col items-center justify-start mx-auto", container)}>
                <motion.div
...
export default linksInBioPreview;