                    ...
                    {step === 1 && (
                        <div className="space-y-6">
                            ...
                            <div className="bg-base-200 rounded-lg p-4">
                                ...
                                <div className="flex items-center gap-3">
                                    <div
                                        className="w-10 h-10 bg-primary rounded-full flex items-center justify-center text-white font-medium">
                    ...
                    {step === 2 && (
                        <>
                            ...
                            <Button
                                ...
                                className="bg-error text-white hover:bg-error-focus disabled:opacity-50"
