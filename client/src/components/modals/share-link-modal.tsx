                ...
                <DialogHeader>
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <DialogDescription className="text-zinc-400">Share your link with friends and family</DialogDescription>
                        </div>
                    </div>
                </DialogHeader>

                <div className="px-6 py-4">
                    <h2 className="block text-xs mb-2 ml-1 uppercase font-bold">
                    ...
                    <div className="my-4 border-t border-base-300 py-4 text-center">
                        <span className="text-sm text-zinc-400">Or share on social media</span>
                    </div>
