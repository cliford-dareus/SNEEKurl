    ...
    return (
        <div className="">
                      ...
                      {qr.logoSrc ? "✓ Included" : "None"}
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    <Button
                                        className="bg-primary hover:bg-primary/90 text-primary-content justify-center"
                                    ...
                                    <Button
                                        className="bg-secondary hover:bg-secondary/90 text-secondary-content justify-center"
                            ...
                            {/* Share Action */}
                            <Button
                                className="w-full bg-accent hover:bg-accent/90 text-accent-content justify-center"
                                onClick={() => {
                                    if (navigator.share) {
                                        navigator.share({
                                            title: 'My QR Code',
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                    className="bg-base-300 hover:bg-base-300/80 text-base-content justify-center"
