  ...
  theme: {
    ...
    extend: {
      animation: {
        ...
        "draw-arrow": "draw-arrow 1s forwards",
      ...
      colors: {
        ...
        // DaisyUI-compatible aliases → theme CSS variables
        // (app uses bg-base-* widely without DaisyUI installed)
        "base-100": "hsl(var(--card))",
        "base-200": "hsl(var(--muted))",
        "base-300": "hsl(var(--border))",
        "base-content": "hsl(var(--foreground))",
        "base-content-secondary": "hsl(var(--muted-foreground))",
